...
public class ServerNio {
    ...
    private static String formResponse(String clientMessage) {
        ...
        if (serverResponse.isEmpty()) {
            return "The original string contained only spaces.";
        } else {
        ...
        try (final ServerSocketChannel serverChannel = ServerSocketChannel.open()) {
            ...
            while (true) {
                try (SocketChannel socketChannel = serverChannel.accept()) {
                    ...
                    writeInBuffer(socketChannel, "Service for delete space started");
                    while (socketChannel.isConnected()) {
                        ...
                        inputBuffer.clear();
                        writeInBuffer(socketChannel, "Processed string:\n" +
